...
class Homeservice2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_homeservice2)
        ...
        next!!.setOnClickListener {
            val lanjut2 = Intent(applicationContext, Homeservice3::class.java)
            startActivity(lanjut2)
        }
        previous!!.setOnClickListener {
            val kembali = Intent(applicationContext, Homeservice::class.java)
